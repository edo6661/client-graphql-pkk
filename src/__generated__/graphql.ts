...
export type Proyek = {
  ...
  lokasi: Scalars['String']['output'];
  mahasiswa?: Maybe<Array<Maybe<Mahasiswa>>>;
  name: Scalars['String']['output'];
  pembimbing?: Maybe<Array<Maybe<Dosen>>>;
  photo?: Maybe<Scalars['String']['output']>;
  tanggalMulai: Scalars['String']['output'];
  tanggalSelesai: Scalars['String']['output'];
...
export type ProyekFieldsFragment = { __typename?: 'Proyek', id: string, name: string, photo?: string | null, batasOrang: number, verified: boolean, lokasi: string, tanggalMulai: string, tanggalSelesai: string, bolehDimulai: boolean, telahSelesai: boolean, description?: string | null, createdAt: string, updatedAt: string, pembimbing?: Array<{ __typename?: 'Dosen', id: string, fullname: string, nidn: string, createdAt: string, updatedAt: string } | null> | null, mahasiswa?: Array<{ __typename?: 'Mahasiswa', id: string, fullname: string, createdAt: string, updatedAt: string } | null> | null, laporans?: Array<{ __typename?: 'Laporan', id: string, photo: string, file: string, createdAt: string, updatedAt: string } | null> | null, biayaOperasionals?: Array<{ __typename?: 'BiayaOperasional', id: string, biayaTransportasi: number, biayaProyek: number, biayaDll: number, tanggalBiaya: string, createdAt: string, updatedAt: string } | null> | null } & { ' $fragmentName'?: 'ProyekFieldsFragment' };
...
export type PersyaratanDetailsFragment = { __typename?: 'Persyaratan', id: string, keteranganKelakuanBaik: boolean, keteranganOrangTua: boolean, keteranganPembayaran: boolean, keteranganSehat: boolean, mahasiswaId: string } & { ' $fragmentName'?: 'PersyaratanDetailsFragment' };
